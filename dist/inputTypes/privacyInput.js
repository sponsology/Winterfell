...
function (_React$Component) {
  ...
  function PrivacyInput(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PrivacyInput).call(this, props));
    _this.state = {
  ...
  _createClass(PrivacyInput, [{
    ...
    value: function render() {
      ...
      }, React.createElement("p", null, "You have set up your Account details. Now you will step through setting up your Profile to find sponsorship alignment opportunities with Givers. Next step is payment of your annual subscription."), React.createElement("input", {
        type: "checkbox",
